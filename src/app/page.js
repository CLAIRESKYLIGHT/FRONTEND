        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          ...
          <div className="card">
            <div className="flex items-center">
              <div className="p-3 rounded-full bg-library-green/10">
                {/* Book Icon */}
                <svg className="w-6 h-6 text-library-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
              </div>
              <div className="ml-4">
                <p className="text-sm font-medium text-library-brown">Total Books</p>
          ...
          <div className="card">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-library-brown">Total Users</p>
          ...
          <div className="card">
            <div className="flex items-center">
              <div className="p-3 rounded-full bg-library-brown/10">
                {/* Clock Icon */}
                <svg className="w-6 h-6 text-library-brown" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <div className="ml-4">
                <p className="text-sm font-medium text-library-brown">Books Borrowed</p>
          ...
          <div className="card">
            <div className="flex items-center">
              <div className="p-3 rounded-full bg-library-red/10">
                {/* Book Return Icon */}
                <svg className="w-6 h-6 text-library-red" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                </svg>
              </div>
              <div className="ml-4">
                <p className="text-sm font-medium text-library-brown">Due Returns</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <Link href="/books" className="group">
            <div className="card transition-all duration-200 hover:shadow-xl cursor-pointer flex items-center justify-between">
              <div>
                <h3 className="text-xl font-semibold text-library-green mb-2" style={{ fontFamily: 'Merriweather, serif' }}>
                  Manage Books
                </h3>
          ...
          <Link href="/users" className="group">
            <div className="card transition-all duration-200 hover:shadow-xl cursor-pointer flex items-center justify-between">
              <div>
                <h3 className="text-xl font-semibold text-library-gold mb-2" style={{ fontFamily: 'Merriweather, serif' }}>
                  Manage Users
                </h3>
                <p className="text-library-brown">
