          ...
          <div className="flex items-center flex-1 max-w-lg space-x-4">
            ...
            <div className="relative w-full">
              <input
                ...
                className="input pl-10 pr-4 py-2.5 bg-slate-50 dark:bg-slate-700 border-slate-200 dark:border-slate-600 text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 rounded-lg transition-all duration-200 text-sm"
        ...
        >
          ...
          <div className="flex items-center">
            ...
            <button
              ...
              className="flex items-center space-x-3 hover:bg-slate-100 dark:hover:bg-slate-700 active:bg-slate-200 dark:active:bg-slate-600 p-2 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-teal-500/20"
              aria-label="Open profile menu"
            >
              {/* Library badge avatar */}
              <div className="h-10 w-10 rounded-lg bg-teal-50 dark:bg-teal-900/30 flex items-center justify-center border border-teal-100 dark:border-teal-800">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
              ...
              <div className="space-y-5">
                ...
                <div className="border-t border-slate-200 dark:border-slate-700 pt-4">
                  <div className="space-y-2">
                    <button className="w-full px-4 py-2 text-sm font-medium text-teal-700 dark:text-teal-300 hover:bg-teal-50 dark:hover:bg-teal-900/20 rounded-lg transition-colors duration-200 flex items-center justify-center border border-teal-100 dark:border-teal-800 focus:outline-none focus:ring-2 focus:ring-teal-500/20">
                      {/* Edit profile icon */}
                      <svg
