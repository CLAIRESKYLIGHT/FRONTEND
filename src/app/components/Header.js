...
export default function Header() {
  ...
  return (
    <>
      <header className="bg-white/80 dark:bg-[#3D1D1F]/80 backdrop-blur-sm border-b border-[#800020]/10 dark:border-[#800020]/20">
          ...
          <div className="flex items-center flex-1 max-w-lg">
            <div className="relative w-full">
              <input
                type="text"
                placeholder="Search..."
                className="w-full pl-10 pr-4 py-2 rounded-lg bg-white/50 dark:bg-[#2D1517]/50 border border-[#800020]/20 dark:border-[#800020]/30 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#800020] focus:border-transparent transition-all duration-200"
              />
      ...
      {isProfileOpen && (
        <div className="fixed inset-0 bg-black/50 dark:bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="bg-white/90 dark:bg-[#3D1D1F]/90 backdrop-blur-sm rounded-xl shadow-xl w-full max-w-md mx-4 transform transition-all duration-300 scale-100">
            <div className="p-6">
