              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  <div className="h-16 w-16 rounded-full bg-blue-100 flex items-center justify-center">
                    <span className="text-blue-600 text-xl font-medium">JD</span>
                  </div>
                  <div>
                ...
                <div className="border-t border-gray-200 pt-4">
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-gray-800">john.doe@example.com</p>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-500">Role</label>
                      <p className="mt-1 text-sm text-gray-800">Administrator</p>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-500">Last Login</label>
                      <p className="mt-1 text-sm text-gray-800">Today at 9:30 AM</p>
                    </div>
                  </div>
                </div>
